$(document).ready(function() {
	...
	ajaxUtils.doPost("member/salesListPaging.do",param,myPageListView);
...
function page(page){
	...
	ajaxUtils.doPost("member/salesListPaging.do",param,myPageListPageView);
}
function myPageListPageView(dataList){
	
	$('#salesTd').html('');
	
	var keyList = [ 'SELL_NO','SELL_BUYER_ID','SELL_IMAGE','SELL_CATEGORY_NAME','SELL_TITLE','SELL_PRICE','SELL_PLACE_NAME','SELL_DATE'];
